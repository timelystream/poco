//
// CompressedFileChannel.h
//
// Library: Foundation
// Package: Logging
// Module:  CompressedFileChannel
//
// Definition of the CompressedFileChannel class.
//
...
#ifndef Foundation_CompressedFileChannel_INCLUDED
#define Foundation_CompressedFileChannel_INCLUDED
...
class Foundation_API CompressedFileChannel: public Channel
	...
	///
	/// The CompressedFileChannel support log file rotation based
...
{
public:
	CompressedFileChannel();
		/// Creates the CompressedFileChannel.

	CompressedFileChannel(const std::string& path);
		/// Creates the CompressedFileChannel for a file with the given path.

	void open() override;
		/// Opens the CompressedFileChannel and creates the log file if necessary.
		
	void close();
		/// Closes the CompressedFileChannel.
...
#endif // Foundation_CompressedFileChannel_INCLUDED
